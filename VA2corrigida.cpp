...
typedef struct {
    ...
    int linha;
    int id_grupo;//tive que adicionair um id_grupo pois o codigo estava fazendo o desfazer e o refazer ao usar a função substituirPalavra palavra por palavra ao inves de desfazer ou refazer a ação inteira 
} Historico;
